...
LANGUAGE C IMMUTABLE STRICT;
CREATE OR REPLACE FUNCTION text_to_can_cpartn(text) RETURNS can_cpartn AS '$libdir/can_cpartn'
LANGUAGE C IMMUTABLE STRICT;
...
CREATE CAST (text AS can_cpartn) WITH FUNCTION text_to_can_cpartn(text) AS ASSIGNMENT;
